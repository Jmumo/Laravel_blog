            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{asset('/storage/images/'.$post->user->profile->avatar)}}" width="100px" alt="Author">
                    </div>
                ...
                <div class="pagination-arrow">
                    ...
                    <a href="{{route('single',$next->slug)}}" class="btn-prev-wrap">
                        <svg class="btn-prev">
                    ...
                    <a href="{{ route('single',$previous->slug)}}" class="btn-next-wrap">
                        <div class="btn-content">
